...
define({
	...
	pokemon: [
		...
		"Marshadow"],
	forms: {
		"Rattata": ["Normal", "Alola"],
		"Raticate": ["Normal", "Alola"],
		"Pikachu": ["Normal", "Cosplay", "Belle", "Libre", "Ph. D", "Pop Star", "Rock Star", "Original Cap", "Hoenn Cap", "Sinnoh Cap", "Unova Cap", "Kalos Cap", "Alola Cap"],
		"Raichu": ["Normal", "Alola"],
		"Sandshrew": ["Normal", "Alola"],
		"Sandslash": ["Normal", "Alola"],
		"Vulpix": ["Normal", "Alola"],
		"Ninetales": ["Normal", "Alola"],
		"Diglett": ["Normal", "Alola"],
		"Dugtrio": ["Normal", "Alola"],
		"Meowth": ["Normal", "Alola"],
		"Persian": ["Normal", "Alola"],
		"Geodude": ["Normal", "Alola"],
		"Graveler": ["Normal", "Alola"],
		"Golem": ["Normal", "Alola"],
		"Grimer": ["Normal", "Alola"],
		"Muk": ["Normal", "Alola"],
		"Exeggutor": ["Normal", "Alola"],
		"Marowak": ["Normal", "Alola"],
		"Pichu": ["Normal", "Spiky-eared"],
		...
		"Vivillon": ["Meadow", "Polar", "Tundra", "Continental", "Garden", "Elegant", "Icy Snow", "Modern", "Marine", "Archipelago", "High Plains", "Sandstorm", "River", "Monsoon", "Savanna", "Sun", "Ocean", "Jungle", "Fancy", "Poké Ball"],
		...
		//"Silvally": ["Type: Normal", "Type: Bug", "Type: Dark", "Type: Dragon", "Type: Electric", "Type: Fairy", "Type: Fighting", "Type: Fire", "Type: Flying", "Type: Ghost", "Type: Grass", "Type: Ground", "Type: Ice", "Type: Poison", "Type: Psychic", "Type: Rock", "Type: Steel", "Type: Water"],
		"Minior": [/*"Meteor", */"Red Core", "Orange Core", "Yellow Core", "Green Core", "Blue Core", "Indigo Core", "Violet Core"],
		"Magearna": ["Normal", "Poké Ball"]},
	abilities: [
		"Adaptability",
		"Aerilate",
		"Aftermath",
