    ...
    return (
      <Well id='footer' bsSize='small'>
        ...
        <a href="https://github.com/techyfatih/nuzlog" target="_blank">
          https://github.com/techyfatih/nuzlog</a><br />
        Report issues here:&nbsp;
        <a href="https://github.com/techyfatih/nuzlog/issues" target="_blank">
          https://github.com/techyfatih/nuzlog/issues</a><br />
        Thread:&nbsp;
        <a href="http://s7.zetaboards.com/Nuzlocke_Forum/topic/11009490/1/"
          target="_blank">
          http://s7.zetaboards.com/Nuzlocke_Forum/topic/11009490/1/</a><br />
        <br />
