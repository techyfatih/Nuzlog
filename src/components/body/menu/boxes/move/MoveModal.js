...
import { Modal, ButtonGroup, Button, Row, Col,
...
class MoveModal extends React.Component {
  ...
  handleDeposit() {
    this.setState(({party, pc, partyIndex}) => ({
      party: [
        ...party.slice(0, partyIndex),
        ...party.slice(partyIndex + 1)
      ],
          ...
          <Row>
            <Col xs={6}>
              <ToggleButtonGroup vertical block type='radio' name='move-party'
                ...
                {six.map((val, key) => (
                  <ToggleButton value={key} key={key} disabled={party[key] == null}
              ...
              <ButtonGroup vertical block>
                <Button bsStyle='primary' href='#' disabled={partyIndex < 0}
            ...
            <Col xs={6}>
              ...
              <ButtonGroup vertical block>
                ...
                <Button bsStyle='warning' href='#' disabled={pcIndex < 0}
