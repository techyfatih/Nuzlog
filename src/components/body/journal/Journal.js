      ...
      <form onSubmit={this.handleSubmit}>
        <FormGroup className="no-margin">
          <InputGroup>
            ...
            />
            <InputGroup.Button>
              <Button type="submit" bsStyle="primary" disabled={!log}>
                Log
              </Button>
              <Button
                bsStyle="danger"
        ...
        >
          ...
          <Modal.Body>
            <p>
              ...
              <br />
              NOTE: This is not your save file! Click "Save/Load Game" to save
              your game.
            </p>
            <FormControl
              id="export"
    ...
    return (
      <div id="journal">
        ...
        >
          ...
          <LogForm
            log={log}
            onLog={log => this.props.recordLog(log)}
